    ...
    return (
        ...
        <div className="flex p-10 justify-center items-center h-screen ">
            <div className="w-full flex justify-center items-center ">
                <img className="rounded-[55px] shadow-lg h-[650px] "src={cocktailimg} />
            </div>
            <div className="w-full">
                <div className="mb-10">
                    <h1 className="font-instrument italic font-meduim text-[80px]">Margarita</h1>
                    <p className="w-4/5 mt-[-15px] font-light">La Margarita est un cocktail classique à base de tequila, de liqueur d'orange (généralement Cointreau ou Triple sec) et de jus de citron vert frais. Ce cocktail est connu pour son équilibre parfait entre le sucré, l'acide et l'alcool, avec une touche de salinité parfois, grâce au sel qui borde le verre.</p>
                </div>
                <div className="mb-[50px] shadow-custom-inset-2 p-8 rounded-3xl w-[60%] ">
                ...
                <div className="flex justify-around items-center w-full pr-[200px]">
                    <div className="flex justify-center items-center">
                        <div className="rounded-xl shadow-custom-inset p-2 w-[60px] h-[60px]"><img src={solarimg}/></div>
                        temps
                    </div>
                    <div className="flex justify-center items-center ">
                        <div className="rounded-xl shadow-custom-inset p-2 w-[60px] h-[60px] font-poppins"><img src={solarstarimg}/></div>
                        note
                    </div>
                    <div className="flex justify-center items-center font-poppins">
                        <div className="rounded-xl shadow-custom-inset p-2 w-[60px] h-[60px] flex justify-center items-center"><img className="h-[35px]" src={shakerimg}/></div>
                        difficulte
                    </div>
                </div>
            </div>
